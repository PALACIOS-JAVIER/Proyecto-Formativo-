...
export function Navegacion({ active, onSelect, onLogout, theme, onToggleTheme }: Props): ReactElement {
  ...
  return (
    <aside className={`sticky top-0 flex w-full flex-col justify-between border-b px-5 py-6 backdrop-blur-sm lg:h-screen lg:w-72 lg:border-b-0 lg:border-r overflow-y-auto ${isDark ? 'border-slate-800 bg-slate-950/95 text-slate-100' : 'border-slate-200 bg-white text-slate-800 shadow-sm'}`}>
      <div>
